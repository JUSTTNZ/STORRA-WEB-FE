...
function PaybilSecretePinModal({ handleClose, handlePaymentSuccess }) {
  ...
  return (
    <div className="fixed inset-0 bg-[#A7A3A3]/1 backdrop-blur-[24px] flex items-center justify-center p-4 z-[70] ">
...
export default PaybilSecretePinModal;
